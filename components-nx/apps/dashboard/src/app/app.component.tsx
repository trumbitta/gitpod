    ...
    (async () => {
      ...
      try {
        ...
        if (error && 'code' in (error as any)) {
          if ((error as any).code === ErrorCodes.SETUP_REQUIRED) {
  ...
  if (window.location.pathname.startsWith('/blocked')) {
    return (
      <div className="mt-48 text-center">
        ...
        <h1 className="mt-12 text-gray-500 text-3xl">
    ...
    <Route>
      <div className="container">
        ...
        <Switch>
          ...
          <Route
            path="/install-github-app"
            exact
            component={InstallGitHubApp}
          />
          ...
          <Route
            path={['/subscription', '/usage', '/upgrade-subscription']}
            exact
          >
            <Redirect to="/plans" />
          </Route>
          ...
          <Route path="/sorry" exact>
            <div className="mt-48 text-center">
              ...
              <p className="mt-4 text-lg text-gitpod-red">
          ...
          <Route path="/projects">
            ...
            <Route
              exact
              path="/projects/:projectName/:resourceOrPrebuild?"
              render={(props) => {
          ...
          {(teams || []).map((team) => (
            <Route path={`/t/${team.slug}`} key={team.slug}>
              ...
              <Route
                ...
                render={(props) => {
                  const { maybeProject, resourceOrPrebuild } =
                    props.match.params;
