...
export default function () {
  ...
  const [lastPrebuilds, setLastPrebuilds] = useState<
    Map<string, PrebuildWithStatus | undefined>
  >(new Map());
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (error && (error as any).code === ErrorCodes.NOT_AUTHENTICATED) {
  ...
  const filter = (branch: Project.BranchDetails) => {
    if (
      searchFilter &&
      `${branch.changeTitle} ${branch.name}`
        .toLowerCase()
        ...
        {showAuthBanner ? (
          ...
          <>
            ...
            <ItemsList className="mt-2">
              ...
              {isLoadingBranches && (
                <div className="flex items-center justify-center space-x-2 text-gray-400 text-sm pt-16">
                              ...
                              ? [
                                  {
                                    ...
                                    onClick: () =>
                                      cancelPrebuild(prebuild.info.id),
                                  },
                                ]
                              : []
                          }
