...
async function registerApp(
  ...
  setModal: (modal: 'done' | string | undefined) => void
) {
  try {
      ...
      <div className="app-container flex flex-col space-y-2">
        <div className="px-6 py-3 flex justify-between space-x-2 text-gray-400">
          <div className="flex flex-col items-center m-auto max-w-lg mt-40">
            <h3 className="text-center pb-3 text-gray-500">
              Install GitHub App
            </h3>
            <div className="text-center pb-6 text-gray-500">
            ...
            <InfoBox>
              This action will also allow Gitpod to access private repositories.
              You can edit Git provider permissions later in user settings.
            </InfoBox>
            <div className="mt-6">
              <button className="secondary">Cancel</button>
              <button
                className="ml-2"
                onClick={() => registerApp(installationId, setModal)}
              >
                Install App
              </button>
            </div>
